	...
	while (1) {
		if (unpaused) {
			...
			*/
				...
				*/
				if (c >= 54 && c <= 58 && _s[0] && VIC_isSpriteInNextLine(0)) {
					_c[c] = 1;
				}
				if (c >= 56 && c <= 60 && _s[1] && VIC_isSpriteInNextLine(1)) {
					_c[c] = 1;
				}
				if (c >= 58 && c <= 62 && _s[2] && VIC_isSpriteInNextLine(2)) {
					_c[c] = 1;
				}
				if ((c >= 60 && c <= 62) && _s[3] && VIC_isSpriteInNextLine(3)) {
					_c[c] = 1;
				}
				...
				if (c >= 1 && c <= 5 && _s[5] && VIC_isSpriteInCurrentLine(5)) {
					_c[c] = 1;
				}
				if (c >= 3 && c <= 7 && _s[6] && VIC_isSpriteInCurrentLine(6)) {
					_c[c] = 1;
				}
				if (c >= 5 && c <= 9 && _s[7] && VIC_isSpriteInCurrentLine(7)) {
					_c[c] = 1;
				}
